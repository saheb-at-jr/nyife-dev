<template>
    <aside class="md:flex flex-col h-full bg-[#EEEEEE] hidden relative transition-all duration-300"
        :class="menuIconsOnly ? 'w-20' : 'w-80'">
        <button @click="toggleMenu"
            class="absolute right-[-18px] top-[32px] bg-slate-100 px-2 py-2 rounded-full shadow-md z-10">
        ...
        <Menu :config="props.config" :user="props.user" :unreadMessages="unreadMessages"
            :organization="props.organization" :organizations="props.organizations" :menuIconsOnly="menuIconsOnly">
        </Menu>
    </aside>
</template>
