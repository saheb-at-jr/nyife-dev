      ...
      <div class="md:flex gap-4">
        <div class="md:w-[65%]">
          <div class="grid grid-cols-2 gap-4">
            <div
              ...
              :class="
                form.plan === item.id
                  ? 'border-gray-700 bg-slate-50'
                  : 'border-slate-100 md:border-white bg-slate-20 md:bg-white'
              "
            >
              <div class="flex justify-between">
                ...
                <div class="">
                  <label for="myCheckbox" class="cursor-pointer">
                    <div
                      class="w-5 h-5 border border-gray-400 rounded-md flex items-center justify-center"
                      :class="form.plan === item.id ? 'bg-[#000]' : ''"
                    >
                      <svg
                        v-if="form.plan === item.id"
              ...
              <h3 v-if="item.period === 'monthly'" class="text-sm mb-4">
                {{ $t("Per month") }}
              </h3>
              <h3 v-if="item.period === 'yearly'" class="text-sm mb-4">
                {{ $t("Per year") }}
              </h3>
              ...
              <div class="flex justify-between text-sm">
                <div class="flex space-x-1">
                  ...
                  <h3>
                    {{
                      getDetail(item?.metadata, "campaign_limit") == "-1"
                        ? $t("Unlimited")
              ...
              <div class="flex justify-between text-sm">
                <div class="flex space-x-1">
                  ...
                  <h3>
                    {{
                      getDetail(item?.metadata, "message_limit") == "-1"
                        ? $t("Unlimited")
              ...
              <div class="flex justify-between text-sm">
                <div class="flex space-x-1">
                  ...
                  <h3>
                    {{
                      getDetail(item?.metadata, "contacts_limit") == "-1"
                        ? $t("Unlimited")
              ...
              <div class="flex justify-between text-sm">
                <div class="flex space-x-1">
                  ...
                  <h3>
                    {{
                      getDetail(item?.metadata, "canned_replies_limit") == "-1"
                        ? $t("Unlimited")
              ...
              <div class="flex justify-between text-sm">
                <div class="flex space-x-1">
                  ...
                  <h3>
                    {{
                      getDetail(item?.metadata, "team_limit") == "-1"
                        ? $t("Unlimited")
              ...
              <div
                v-for="(value, key) in filteredAddons(item)"
              ...
              <div
                v-if="props.enable_ai_billing == 1"
                class="flex justify-between text-sm"
              >
                <div class="flex space-x-1">
                  <span>
                    <svg
                      v-if="
                        ...
                        filteredAddons(item)['AI Assistant']
                      "
                      xmlns="http://www.w3.org/2000/svg"
                      width="16px"
                      height="16px"
        ...
        <div class="md:w-[35%]">
          <div class="bg-white rounded-md shadow-md p-5">
            ...
            <div v-if="!form.plan">
              <div
                class="border border-dashed flex itens-center justify-center p-10 rounded-md"
              >
            ...
            <div v-if="form.plan">
              <div class="flex justify-between mb-4 text-sm">
                <div>
                  ...
                  <h3
                    class="bg-slate-100 w-[fit-content] py-1 px-2 rounded-md capitalize text-xs"
                  >
                    {{ selectedPlan.period }}
                  </h3>
                </div>
              ...
              >
                <div class="flex justify-between text-sm">
                  <div>
                    {{ $t("Available debits") }} <br /><span class="text-xs"
                      >({{ $t("Applicable debits due") }})</span
                    >
                  </div>
                  <h3>{{ debit.total }}</h3>
                </div>
              ...
              >
                <div class="text-sm">
                  <div class="text-sm border-b border-dashed">
                    {{ $t("Coupon code") }}
                  </div>
                  <form
                  ...
                  >
                    <div class="flex items-center justify-between">
                      <input
                        ...
                        class="h-full w-3/4 outline-none"
                      />
                      <button
                        :class="[
                          'h-full w-[fit-content] py-0.5 px-2 text-[12px] flex items-center justify-center bg-primary text-white rounded-md',
                          { 'opacity-50': form1.processing },
                        ]"
                        :disabled="form1.processing"
                      >
                        <svg
                          v-if="form1.processing"
                          xmlns="http://www.w3.org/2000/svg"
                          width="24"
                          height="24"
                          viewBox="0 0 24 24"
                    ...
                    <span
                      ...
                      v-if="form1.errors.coupon"
                      >{{ form1.errors.coupon }}</span
                    >
                  </form>
                  ...
                  <div v-else class="mt-2 flex justify-between text-sm">
                    <div class="flex items-center">
                      <h3>{{ coupon?.code }}</h3>
                      <span v-if="coupon?.type == 'percentage'" class=""
              ...
              <div class="mt-8">
                <button
                  v-if="!buttonLoading || (!buttonLoading && amountDue <= 0)"
...
>
  <div
    class="bg-white p-6 rounded-lg shadow-lg w-96 text-center"
  >
    <h2 class="text-lg font-semibold mb-4">Confirm Action</h2>
    <p class="text-gray-600 mb-2">
      Are you sure want to continue with this action?
    </p>
    <p class="text-sm text-red-600 mb-6">
      Note: Subscription amount will be deducted from your wallet.
    </p>
...
const submitForm = async () => {
  ...
  console.log(amountDue.value);

  buttonLoading.value = true;
  console.log("buttonLoading set to:", buttonLoading.value);
  ...
  try {
    ...
    await form.post("/subscription", {
      ...
      onFinish: () => {
        ...
        console.log("buttonLoading reset to:", buttonLoading.value);
      },
    });
  } catch (error) {
