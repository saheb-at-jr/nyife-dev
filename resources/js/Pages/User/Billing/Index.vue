<template>
  ...
  <AppLayout>
    ...
    >
      ...
      <div
        class="md:flex bg-slate-100 md:bg-white shadow-sm p-5 rounded-[0.5rem] space-y-6"
      >
        <div class="md:w-[50%]">
          <div class="mb-5">
          ...
          >
            ...
            <!-- <div>
                            <h2 class="text-sm text-gray-500 tracking-[0px]">{{ $t('Amount Paid') }}</h2>
        ...
        <div class="md:w-[50%]">
          <div
            class="md:float-right gap-y-2 gap-x-3"
            :class="
              props.setting['enable_custom_payment'] == 0
                ? 'flex'
                : 'grid grid-cols-2'
            "
          >
      ...
      <div
        class="bg-slate-100 md:bg-gray-50 p-5 md:px-0 rounded-[0.5rem] mt-10 w-full"
      >
        <div class="w-full">
          <div class="mb-5">
