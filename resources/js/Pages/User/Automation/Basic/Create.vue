                ...
                <div class="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <div class="flex items-center text-sm text-slate-600">
                            ...
                            <span>{{ $t('Create reply automation using your own criteria') }}</span>
                        </div>
                    </div>
                    <Link href="/automation/basic"
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            <div>
                                <h3 class="text-sm font-semibold text-slate-900 mb-1">
                                    {{ form.response_type === 'image' ? $t('Image response') : $t('Audio response') }}
                                </h3>
                            ...
                            <div class="lg:col-span-2">
                                <div class="space-y-4">
                                    <div :class="form.errors.response ? 'border-red-500' : 'border-slate-300'"
                                        class="relative flex flex-col items-center justify-center px-6 py-8 border-2 border-dashed rounded-2xl bg-white hover:bg-slate-50 transition-colors duration-200 cursor-pointer">
                                        <input type="file"
                                        ...
                                        <div v-if="form.response"
                                            class="flex items-center space-x-3 p-4 bg-slate-100 rounded-xl border border-slate-200 mb-4">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <p class="text-sm font-medium text-slate-900 truncate">{{
                                                    form.response?.name ?? form.response }}</p>
                                            </div>
                                            <button type="button" @click.stop="clearResponse()"
