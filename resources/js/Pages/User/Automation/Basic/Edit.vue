        ...
        <div
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                <div class="mb-4 md:mb-0">
                    <h2 class="text-2xl font-bold text-gray-900 mb-2">{{ $t('Update automation') }}</h2>
                    <p class="flex items-center text-sm text-gray-600">
                        ...
                        <span class="ml-2">{{ $t('Update your setup') }}</span>
                    </p>
                </div>
                <Link href="/automation/basic"
                    class="inline-flex items-center px-5 py-2.5 bg-white hover:bg-gray-50 text-gray-700 rounded-xl font-medium transition-all duration-200 border-2 border-gray-200 hover:border-gray-300 shadow-sm">
            ...
            <form @submit.prevent="submitForm()"
                ...
                <!-- Template Response Section -->
                <div v-else-if="form.response_type === 'template'"
                    class="p-6 bg-gradient-to-br from-orange-50/30 to-transparent">
                    <div class="max-w-4xl mx-auto">
                        <div class="mb-4">
                            <h3 class="text-sm font-semibold text-gray-700 mb-2">{{ $t('Template response') }}</h3>
                            <p class="text-xs text-gray-500">Select a template to send as response</p>
                        </div>

                        <div
                            class="bg-white rounded-xl border-2 border-gray-200 focus-within:border-[#ff5100] transition-colors p-4">
                            <FormSelectCombo v-model="form.response" :loadOptions="loadTemplates"
                                :error="form.errors.response" :class="'w-full'" :placeholder="'Select Template'" />
                        </div>
