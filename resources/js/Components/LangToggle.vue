...
<template>
    <div class="relative text-sm">
        ...
        <div v-if="isOpen"
            class="absolute bg-white z-10 px-1 py-2 mt-2 shadow w-full rounded-md min-w-[8em] text-black">
            <div>
                <a v-for="(item, index) in props.languages" :href="'/language/' + item.code"
