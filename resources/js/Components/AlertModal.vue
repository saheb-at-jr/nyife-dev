                        ...
                        <DialogPanel
                            ...
                            <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                <button v-if="!isLoading" type="button" :class="[
                                    'inline-flex w-full bg-primary justify-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm sm:ml-3 sm:w-auto',
                                    confirmButtonClass
                                ]" @click="confirm">
                                    {{ confirmButtonText }}
                                </button>
                                ...
                                <button type="button"
                                    ...
                                    @click.self="onClose" ref="cancelButtonRef">{{ $t('Cancel') }}</button>
                            </div>
                        </DialogPanel>
                    </TransitionChild>
                </div>
