...
<template>
    <div v-if="visible"
        class="mr-auto rounded-lg rounded-tl-none my-[0.1em] p-1 text-sm bg-white flex flex-col relative speech-bubble-left max-w-[25em]">
        <div v-if="parameters.header.format != null && parameters.header.format != 'TEXT'">
            ...
            <div v-else class="mb-4 flex justify-center rounded">
                <div v-if="parameters.header.format === 'IMAGE'" class="relative w-full h-full">
                    <img :src="parameters.header.parameters[0].value" alt="Image"
                        class="rounded-md flex justify-center items-center z-1 w-full h-full" />
                </div>
                ...
                <div v-if="parameters.header.format === 'DOCUMENT'">
                    <div class="relative">
                        <div class="flex space-x-2 w-full h-1/3 bg-white opacity-90 pt-2">
                            <div>
                                <svg v-if="getExtension(parameters.header.parameters[0].value) === 'PDF'"
                                    xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 1024 1024">
                                    <path fill="red"
                                ...
                                <svg v-if="getExtension(parameters.header.parameters[0].value) === 'XLSX' || getExtension(parameters.header.parameters[0].value) === 'XLS'"
                                    ...
                                    <defs>
                                        <linearGradient id="vscodeIconsFileTypeExcel0" x1="4.494" x2="13.832"
                                            y1="-2092.086" y2="-2075.914" gradientTransform="translate(0 2100)"
                                ...
                                <svg v-if="getExtension(parameters.header.parameters[0].value) === 'DOC' || getExtension(parameters.header.parameters[0].value) === 'DOCX'"
                                    xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 32 32">
                                    <defs>
                                        <linearGradient id="vscodeIconsFileTypeWord0" x1="4.494" x2="13.832"
                                            y1="-1712.086" y2="-1695.914" gradientTransform="translate(0 1720)"
                                            gradientUnits="userSpaceOnUse">
                                ...
                                <svg v-if="getExtension(parameters.header.parameters[0].value) === 'PPT' || getExtension(parameters.header.parameters[0].value) === 'PPTX'"
                                    xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 32 32">
                                    <defs>
                                ...
                                <svg v-if="getExtension(parameters.header.parameters[0].value) === 'TXT'"
                                    xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 16 16">
                            ...
                            <a :href="parameters.header.parameters[0].value" @click="downloadClicked"
        ...
        <div class="text-[#8c8c8c] mt-1 px-2">
            ...
            <span class="text-right text-xs leading-none float-right"
                :class="parameters.footer.text ? 'mt-2' : ''">9:15</span>
        </div>
    </div>
    <div v-if="parameters?.buttons?.length > 0"
        class="mr-auto text-sm text-[#00a5f4] flex flex-col relative max-w-[25em]">
        <div v-for="(item, index) in parameters.buttons" :key="index"
